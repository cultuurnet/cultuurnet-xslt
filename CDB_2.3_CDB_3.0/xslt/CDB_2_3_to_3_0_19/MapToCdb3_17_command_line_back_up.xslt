...
<xsl:stylesheet version="1.0" xmlns="http://www.cultuurdatabank.com/XMLSchema/CdbXSD/3.0/FINAL" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cc="http://www.cultuurdatabank.be/XMLSchema/Culture_CS" xmlns:sc="http://www.cultuurdatabank.be/XMLSchema/SA_comp" xmlns:ad="http://www.cultuurdatabank.be/XMLSchema/address" xmlns:ca="http://www.cultuurdatabank.be/XMLSchema/categorisation" xmlns:ci="http://www.cultuurdatabank.be/XMLSchema/city_area" xmlns:ct="http://www.cultuurdatabank.be/XMLSchema/city_comp" xmlns:co="http://www.cultuurdatabank.be/XMLSchema/country" xmlns:ec="http://www.cultuurdatabank.be/XMLSchema/event_cluster" xmlns:ed="http://www.cultuurdatabank.be/XMLSchema/event_date" xmlns:gc="http://www.cultuurdatabank.be/XMLSchema/gis_comp" xmlns:lc="http://www.cultuurdatabank.be/XMLSchema/language_comp" xmlns:mc="http://www.cultuurdatabank.be/XMLSchema/mail_comp" xmlns:me="http://www.cultuurdatabank.be/XMLSchema/media" xmlns:md="http://www.cultuurdatabank.be/XMLSchema/metadata" xmlns:na="http://www.cultuurdatabank.be/XMLSchema/name_comp" xmlns:no="http://www.cultuurdatabank.be/XMLSchema/note_comp" xmlns:ot="http://www.cultuurdatabank.be/XMLSchema/opening_times" xmlns:or="http://www.cultuurdatabank.be/XMLSchema/organisation" xmlns:pe="http://www.cultuurdatabank.be/XMLSchema/person" xmlns:ph="http://www.cultuurdatabank.be/XMLSchema/phone" xmlns:pr="http://www.cultuurdatabank.be/XMLSchema/price" xmlns:ref="http://www.cultuurdatabank.be/XMLSchema/reference_item" xmlns:rn="http://www.cultuurdatabank.be/XMLSchema/region_nat" xmlns:rel="http://www.cultuurdatabank.be/XMLSchema/relation_item" xmlns:sp="http://www.cultuurdatabank.be/XMLSchema/street_part" xmlns:uc="http://www.cultuurdatabank.be/XMLSchema/url_comp" xmlns:zc="http://www.cultuurdatabank.be/XMLSchema/zip_codes" xmlns:java="http://xml.apache.org/xalan/java" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:extfun="external_functions" xmlns:file="java.io.File" xmlns:xalan="http://xml.apache.org/xalan" xmlns:url="java.net.URL" xmlns:stream="java.io.InputStream" xmlns:url_conn="java.net.URLConnection" exclude-result-prefixes="cc sc ad ca ci ct co ec ed gc lc mc me md na no ot or pe ph pr ref rn rel sp uc zc xs xalan java extfun file">
	...
	<xalan:component prefix="extfun">
		...
		var url_2 = new java.net.URI(url_in)
		var file = url_1.getContent()
		
		var file_1 = file.toString()
		
		
	
		
		//var file = new java.io.FileInputStream(url_2)
		//var file_in = new java.io.InputStreamReader(url_1,'ISO-8859-1')
		...
		var read_char = new java.lang.String  
		
		
		while ((read = open_stream.read()) != -1) {
		
		
		//all_text.append(read).toString()
		//all_text.append(read)
		//read_char = read.getBytes()
		str += read + ';'
		...
		//var st = new java.lang.String(str,1,1000,'ISO-8859-1')
		
		//var st = Integer.toBinaryString(str byteArray);
		
		//String st = new String(byteArray);
		//st = str.toString()
		//var st = new java.lang.String(all_text,'ISO-8859-1')
		...
		all_text_8 = all_text_7.replace(/39/g,'&quot;') // single quote
		...
		all_text_54 = all_text_52.replace(/85/g,'U')
		...
		all_text_97 = all_text_96.replace(/128/g,'_')
		...
		all_text_102 = all_text_101.replace(/133/g,'_')
		...
		all_text_114 = all_text_113.replace(/145/g,'_')
		all_text_115 = all_text_114.replace(/146/g,'_')
		all_text_116 = all_text_115.replace(/147/g,'_') 
		all_text_117 = all_text_116.replace(/148/g,'_')
		all_text_118 = all_text_117.replace(/149/g,'_') 
		all_text_119 = all_text_118.replace(/150/g,'_')
		...
		all_text_123 = all_text_122.replace(/154/g,'_')
		...
		all_text_141 = all_text_140.replace(/172/g,'') // nothing
		...
		// CR LF :
		all_text_94 = all_text_92.replace(/10/g,'&#10')
		all_text_94 = all_text_93.replace(/13/g,'&#13')
		
		// replace the seperators with nothing :
		all_text_all = all_text_224.replace(/;/g,'')
												...
												<xsl:when test="substring(./file,($media_length)-3,4) = '.txt'">
													...
													<xsl:if test="string(./value_plain_text/dutch) != 'kinderen toegelaten'">
														...
														<xsl:if test="string(./category/categorisation_instance/label/dutch) != 'prijsomschrijvingen en kortingen'">
															...
															<!-- use the CDB media store to get the media files : http://www.cultuurweb.be/CNETPortal/media/   -->
															<!-- NOK : 	<xsl:variable name="full_text_file" select="concat('http://www.cultuurweb.be/CNETPortal/media/',$text_file)"/>  
																				<xsl:variable name="full_text_file" select="concat('http:\\www.cultuurweb.be\CNETPortal\media\',$text_file)"/>
																				<xsl:variable name="full_text_file" select="concat('http://www.cultuurweb.be\CNETPortal\media\',$text_file)"/>
-->
															<xsl:variable name="url" select="concat('http://www.cultuurweb.be/CNETPortal/media/',$text_file)"/>
															<xsl:variable name="url_1" select="url:new($url)"/>
															<xsl:variable name="url_test" select="url:openConnection($url_1)"/>
															<xsl:variable name="url_connection" select="url_conn:getContentLength($url_test)"/>
															<!-- check if the file exists first -->
															<!-- following test was : xsl:if test="$url_connection &gt; 0" but some bad urls still got through -->
															<!-- works !!!
															<xsl:if test="$url_connection &gt; 400">
...
-->
															...
															<xsl:if test="position() = 1">
																<xsl:choose>
																	<xsl:when test="$url_connection &gt; 400">
																		<xsl:variable name="text_string">
																	<xsl:value-of select="extfun:writeLoop(string($url))"/>
																</xsl:variable>
																<longdescription>
