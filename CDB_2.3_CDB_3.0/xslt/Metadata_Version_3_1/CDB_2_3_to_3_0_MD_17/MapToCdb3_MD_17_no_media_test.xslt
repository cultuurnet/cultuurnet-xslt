													...
													<xsl:if test="string(./value_plain_text/dutch) != 'kinderen toegelaten'">
														...
														<xsl:if test="string(./category/categorisation_instance/label/dutch) != 'prijsomschrijvingen en kortingen'">
															...
															<xsl:variable name="local_dir_2">
																<!-- <xsl:value-of select="substring($local_dir_1,7)"/> -->
																<xsl:value-of select="substring($local_dir_1,6)"/>
															</xsl:variable>
															<xsl:variable name="local_dir_3">
																<!-- <xsl:value-of select="substring($local_dir_2,1,69)"/> -->
																<!-- change this so we calculate the position of the last / -->
																<xsl:value-of select="substring($local_dir_2,1,70)"/>
															</xsl:variable>
