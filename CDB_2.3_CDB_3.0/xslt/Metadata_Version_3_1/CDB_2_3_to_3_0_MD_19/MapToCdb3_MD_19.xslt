...
This version takes .txt files from where the CDB stores them and copies them into the longdescription part of the CDB XML 3.1
Nothing is done with media files.
Use this for exports from the cdb.
-->
												...
												<xsl:when test="substring(./file,($media_length)-3,4) = '.txt'">
													...
													<xsl:if test="string(./value_plain_text/dutch) != 'kinderen toegelaten'">
														...
														<xsl:if test="string(./category/categorisation_instance/label/dutch) != 'prijsomschrijvingen en kortingen'">
															...
															<!--  this order is the fastest.
																select="concat('http://212.117.81.133/igo_dyn/igomedia/',$text_file)"/>
																select="concat('http://media.cultuurnet.be/media/',$text_file)"/>
																select="concat('http://build.uitdatabank.be/media/',$text_file)"/>
																select="concat('http://212.117.81.133/igo_dyn/igomedia/',$text_file)"/>
																select="concat('http://www.cultuurweb.be/CNETPortal/media/',$text_file)"/>
