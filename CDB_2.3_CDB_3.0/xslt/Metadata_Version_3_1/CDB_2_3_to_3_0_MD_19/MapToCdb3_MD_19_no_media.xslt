...
Nothing is done with media files.
												...
												<xsl:when test="substring(./file,($media_length)-3,4) = '.txt'">
													...
													<xsl:if test="string(./value_plain_text/dutch) != 'kinderen toegelaten'">
														...
														<xsl:if test="string(./category/categorisation_instance/label/dutch) != 'prijsomschrijvingen en kortingen'">
															...
															<!-- from IIS3 : file:/opt/iis3/publications/46/SKB_Import_Delta_090507171801449_processing/transform1_SKB_adjust_lab_url_pho_rel_price.temp  -->
															<!-- from PC  : file:///D:/XML/XML/SKB/SKB00001_200905052300_0001_D/SKB00001_200905052300_0001_D.xml -->
															...
															<xsl:if test="position() = 1">
																<xsl:choose>
																	...
																	<xsl:otherwise>
																		<!-- in this case copy the long desctiption from value plain text. This is where I will put the Socius long descriptions -->
															...
															-->
															<!-- construct the complete url and check the url exists 
														<xsl:variable name="test_file_url">
															<xsl:variable name="url_1" select="concat('http://build.uitdatabank.be/media/',$text_file)"/>
															...
															<xsl:choose>
																...
																<xsl:otherwise>
																	<xsl:variable name="url_2" select="concat('http://212.117.81.133/igo_dyn/igomedia/',$text_file)"/>
																	...
																	<xsl:choose>
																		...
																		<xsl:otherwise>
																			...
																			<xsl:choose>
																				...
																				<xsl:otherwise>
																					<xsl:variable name="url_4" select="concat('http://212.117.81.133/igo_dyn/igomedia/',$text_file)"/>
