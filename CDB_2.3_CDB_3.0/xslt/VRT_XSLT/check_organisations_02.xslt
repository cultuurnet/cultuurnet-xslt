						...
						<xsl:choose>
							<xsl:when test="string(n1:location/n1:actor/n1:actorcategories/n1:publicscope) = 'Lokaal' or
								...
								<xsl:variable name="loc_add_to_xml">
									<xsl:for-each select="document($ghgp_list)/Report/table1/Detail_Collection/Detail[label = $location_name]">
								...
								<xsl:variable name="org_add_to_xml">
									<xsl:for-each select="document($ghgp_list)/Report/table1/Detail_Collection/Detail[label = $organiser_name]">
										<!-- get the id from the list -->
										<xsl:variable name="id_from_list">
											<xsl:value-of select="./GUID"/>
										</xsl:variable>
								...
								<xsl:variable name="row_from_list_loc">
									<xsl:value-of select="document($ghgp_list)/Report/table1/Detail_Collection/Detail[label = $location_name]"/>
								</xsl:variable>
								<xsl:variable name="row_from_list_org">
									<xsl:value-of select="document($ghgp_list)/Report/table1/Detail_Collection/Detail[label = $organiser_name]"/>
								</xsl:variable>
								<!--
								xxxxx
