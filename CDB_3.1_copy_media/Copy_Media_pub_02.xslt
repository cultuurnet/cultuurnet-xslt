...
Only use this for external imports  (Socuis, SKB etc). It is not needed for feeds from the CDB.
-->
...
return true;
	...
	<xsl:template match="/n1:cdbxml">
		...
		http://www.cultuurdatabank.com/XMLSchema/CdbXSD/3.1/DRAFT/CdbXSD.xsd</xsl:attribute>
			...
			<!-- we are going to copy to this to a local directory in the IIS3 -->
